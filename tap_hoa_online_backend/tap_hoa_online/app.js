...
var user_socket_connect_list = []; // Danh sách lưu trữ các người dùng kết nối qua socket

// Cấu hình view engine và thư mục views
app.set('views', path.join(__dirname, 'views')); // Thiết lập thư mục chứa các file view
